...
const Banner = () => {
  return (
    <>
      ...
      <section
        id="header"
        className="bg-[#EF9F9F] mb-2 shadow-md fixed top-0 left-0 w-full z-[999999999999] rounded-t-md"
      >
        <div className="container flex justify-between items-center">
          <div className="logoWrapper px-2 flex  justify-center items-center">
          ...
          <div className="menu">
            <label className="btn btn-circle swap swap-rotate text-[#323232] dark:text-[#fbfcfc]">
